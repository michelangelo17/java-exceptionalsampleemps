# Java Sample Exceptional Employees

## Introduction

This project is used to introduce Java Spring REST API CRUD applications and using custom exception handling. As such it is a small application showing just the code that is needed to explain the topic.
