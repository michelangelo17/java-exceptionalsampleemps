# Java Exceptional Sample Employees Initial Version

## Introduction

This project is used to introduce Java Spring REST API CRUD applications. As such it is a small application showing just the code that is needed to explain the topic. This application is the same as the application from [https://github.com/LambdaSchool/java-sampleemps.git/sampleemps_data_modeling](https://github.com/LambdaSchool/java-sampleemps.git) with the addition of find employee by id endpoints and associated code and will be used as a starting point to discuss custom exception handleing
